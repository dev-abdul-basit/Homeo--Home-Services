...
class TabPendingOffers extends StatefulWidget {
  const TabPendingOffers({Key? key}) : super(key: key);

  @override
  State<TabPendingOffers> createState() => _TabPendingOffersState();
}

class _TabPendingOffersState extends State<TabPendingOffers> {
